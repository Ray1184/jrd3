...
import org.jrd3.engine.core.graph.renderer.GUI2DRenderer;
 ...
 * @version 1.0
 */
public class GUI2DState extends AbstractState {
     ...
     */
    public GUI2DState(String scriptPath) {
        super(scriptPath);
    }
    ...
    public void init() throws JRD3Exception {
        ...
        renderer = new GUI2DRenderer(new PixelationPostProcessingFx(getWindow().getWidth(), getWindow().getHeight(), pixelRatio));
