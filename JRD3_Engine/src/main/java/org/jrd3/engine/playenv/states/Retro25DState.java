...
import org.jrd3.engine.core.graph.renderer.Retro25DRenderer;
 ...
 * @version 1.0
 */
public class Retro25DState extends AbstractState {
     ...
     */
    public Retro25DState(String scriptPath) {
        super(scriptPath);
    }
    ...
    public void init() throws JRD3Exception {
        ...
        renderer = new Retro25DRenderer(new PixelationPostProcessingFx(getWindow().getWidth(), getWindow().getHeight(), pixelRatio));
    ...
    public void update(float tpf) throws JRD3Exception {
        ...
        // NOT USED WITH AUTO CAMERA CHANGING
