...
public class Retro25DRenderer implements Renderer {
    ...
    public Retro25DRenderer() {
        this(null);
    }


    public Retro25DRenderer(PostProcessingFx postProcessingFx) {
    ...
    public void render(Window window, Camera camera, Scene scene) {
        ...
        renderDepthLayers(window, scene);
    ...
    private void setupDepthLayersShader() throws JRD3Exception {
        depthShaderProgram = RenderUtils.createDepthMaskShader();
    }
    ...
    private void renderDepthLayers(Window window, Scene scene) {
        RenderUtils.renderDepthLayers(window, scene, depthShaderProgram);
    }
